...
// The function returns a rulestree.ResultFunction that can be used to modify the ProcessedAuctionRequestPayload in the ChangeSet.
// The function is used to create result functions for the rules engine in the Prebid Server.
func NewProcessedAuctionRequestResultFunction(name string, params json.RawMessage) (rulestree.ResultFunction[hs.ChangeSet[hs.ProcessedAuctionRequestPayload]], error) {
...
func NewExcludeBidders(params json.RawMessage) (rulestree.ResultFunction[hs.ChangeSet[hs.ProcessedAuctionRequestPayload]], error) {
...
func NewIncludeBidders(params json.RawMessage) (rulestree.ResultFunction[hs.ChangeSet[hs.ProcessedAuctionRequestPayload]], error) {
...
func NewLogATag(params json.RawMessage) (rulestree.ResultFunction[hs.ChangeSet[hs.ProcessedAuctionRequestPayload]], error) {
